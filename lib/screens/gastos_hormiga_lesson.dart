            ...
            child: Column(
              ...
              children: [
                ...
                const _LessonHeader(
                  ...
                  color: AppColors.systemOrange,
                  title: 'Gastos\nHormiga',
                  subtitle: '¿Cuál es un gasto hormiga?',
                ),
                const SizedBox(height: 32),
                const Text(
                  'Selecciona los gastos hormiga',
                  style: TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.w600,
                    color: Colors.white70,
                ...
                Center(
                  child: Text(
                    'Selecciona café diario y Spotify',
                    style: TextStyle(
                      fontSize: 12,
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _LessonHeader(
                    ...
                    color: AppColors.systemOrange,
                    title: 'Gastos\nHormiga',
                    subtitle: 'Así están los gastos hormiga:',
                  ),
                  const SizedBox(height: 24),
                  const Text(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      const Text(
                        'Un gasto de \$50 diarios suma \$18,250 al año. ¡Equivalent a un viaje!',
                        style: TextStyle(
                          fontSize: 15,
                          color: Colors.white,
                          height: 1.5,
